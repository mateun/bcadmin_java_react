...
var LoginForm = function (_React$Component) {
	...
	function LoginForm(props) {
		...
		console.log("in ctr: " + _this.state.username);
	...
	_createClass(LoginForm, [{
		...
		value: function handleSubmit(event) {
			...
			_axios2.default.post('/BitCoinAdmin/signin2', {
...
var Fetcher = function (_React$Component2) {
	_inherits(Fetcher, _React$Component2);

	function Fetcher(props) {
		_classCallCheck(this, Fetcher);

		var _this2 = _possibleConstructorReturn(this, (Fetcher.__proto__ || Object.getPrototypeOf(Fetcher)).call(this, props));
	...
	_createClass(Fetcher, [{
		...
		value: function componentDidMount() {
			...
			_axios2.default.get('http://localhost:8080/BitCoinAdmin/user_standalone').then(function (res) {
				var user = res.data;
				console.log("user: " + user.firstName);
				var ts = [];
				_this3.setState({ transactions: ts,
					username: user.firstName });

				console.log("user from state: " + _this3.state.username);
			});
		}
	}, {
		key: 'render',
...
_reactDom2.default.render(_react2.default.createElement(LoginForm, null), document.getElementById('root'));
